...
class Scene extends React.Component {
    ...
    setupWorldAsync = async () => {
        ...
        const slotted_disk = await this.loadMesh(require('../assets/models/stl/ascii/slotted_disk.stl'))
        ...
        const headpan = await this.loadMesh(require('../assets/models/stl/binary/pr2_head_pan.stl'))
        ...
        const tilt = await this.loadMesh(require('../assets/models/stl/binary/pr2_head_tilt.stl'))
        ...
        const colored = await this.loadMesh(require('../assets/models/stl/binary/colored.stl'))
        var meshMaterial = material;
        if (colored.hasColors) {
            meshMaterial = new THREE.MeshPhongMaterial({ opacity: colored.alpha, vertexColors: THREE.VertexColors });
        }
