...
let {cloth,ballPosition, simulate,ballSize, clothFunction} = require('../assets/components/Cloth');
...
export default class AnimationCloth extends React.Component {
  ...
  button = ({text, onPress}) => (
    <TouchableOpacity style={{flex: 1, backgroundColor: 'rgba(255,255,255,0.4)', borderRadius: 4, paddingVertical:12, margin: 4, justifyContent: 'center', alignItems: 'center'}} onPress={onPress}>
    ...
    return (
      <View style={{flex: 1}}>
        ...
        <View style={{position: 'absolute',padding: 24, top: 20, left: 0, right: 0, justifyContent: 'space-around',}}>
          <Text style={{textAlign: 'center', marginBottom: 8, backgroundColor: 'transparent'}}>Simple Cloth Simulation Verlet integration with relaxed constraints</Text>
